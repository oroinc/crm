...
class ChangeIntegrationStatusProcessorTest extends WebTestCase
{
    ...
    public function testProcess(): void
    {
        ...
        /** @var Cache $cache */
        $cache = self::getContainer()->get('oro_channel.state_cache');
        // Checks that cache is warmed up
        self::assertTrue($cache->contains(StateProvider::CACHE_ID. '_'));
        ...
        self::assertFalse($cache->contains(StateProvider::CACHE_ID. '_'));
    }
}
