...
import Select2GridComponent from 'oro/select2-grid-component';
import BaseSelect2View from 'oroform/js/app/views/select2-view';
import viewFactory from 'orochannel/js/app/factory/select2-channel-aware-view-factory';
...
export default Select2GridChannelAwareComponent;
