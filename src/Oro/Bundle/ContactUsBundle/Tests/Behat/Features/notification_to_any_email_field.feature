...
Scenario: Administrator creates notification rule for "Contact request" and picks "Email" fields as recipients
    ...
    # emailAddress,organizationName,TableColumnStringField,SerializedTextField
...
Scenario: Administrator checks state of previously created notification rule
    And I go to System/ Emails/ Notification Rules
    And I click edit "Contact Request" in grid
    # what expected here? An absence of checkboxes?
    #And I should not see an "" element
	#emailAddress,organizationName,TableColumnStringField
    And I wait for action


  # what about fields removing and restoring
