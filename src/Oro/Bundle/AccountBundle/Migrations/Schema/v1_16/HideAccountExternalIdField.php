...
namespace Oro\Bundle\AccountBundle\Migrations\Schema\v1_16;
...
/**
 * Fully hides externalId field of Account entity from grid, filters, view and edit form.
 */
class HideAccountExternalIdField implements Migration, ExtendOptionsManagerAwareInterface
{
