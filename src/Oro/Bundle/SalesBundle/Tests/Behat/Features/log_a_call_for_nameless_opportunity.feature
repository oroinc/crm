@ticket-CRM-9070
@fixture-OroSalesBundle:nameless_opportunity.yml

Feature: Log a call for nameless opportunity
  In order to have ability work with opportunities
  As administrator
  I need to have ability log a call for nameless opportunity

  Scenario: Log a call for nameless opportunity
