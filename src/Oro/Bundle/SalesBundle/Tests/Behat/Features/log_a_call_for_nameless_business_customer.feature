@ticket-CRM-9070
@fixture-OroSalesBundle:nameless_business_customer.yml

Feature: Log a call for nameless business customer
  In order to have ability work with business customers
  As administrator
  I need to have ability log a call for nameless business customer

  Scenario: Log a call for nameless business customer
