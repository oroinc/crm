@ticket-CRM-9070
@fixture-OroSalesBundle:nameless_lead.yml

Feature: Log a call for nameless lead
  In order to have ability work with leads
  As administrator
  I need to have ability log a call for nameless lead

  Scenario: Log a call for nameless lead
