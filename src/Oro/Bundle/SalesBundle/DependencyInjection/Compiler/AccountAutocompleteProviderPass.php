...
class AccountAutocompleteProviderPass implements CompilerPassInterface
{
    const CHAIN_SERVICE     = 'oro_sales.provider.customer.account_autocomplete.chain';
    const PROVIDER_TAG_NAME = 'oro_sales.provider.customer.account_autocomplete';
