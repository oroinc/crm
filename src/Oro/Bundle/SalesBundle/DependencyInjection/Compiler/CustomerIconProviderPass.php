...
class CustomerIconProviderPass implements CompilerPassInterface
{
    const CHAIN_SERVICE     = 'oro_sales.provider.customer.chain_customer_icon';
    const PROVIDER_TAG_NAME = 'oro_sales.customer_icon';
