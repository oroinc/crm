...
class OpportunitiesGridBlockPriorityProviderPass implements CompilerPassInterface
{
    const CHAIN_SERVICE     = 'oro_sales.provider.customer.opportunities_grid.block_priority.chain';
    const PROVIDER_TAG_NAME = 'oro_sales.provider.customer.opportunities_grid.block_priority';
