...
Feature: Public and private emails in contact activities
  ...
  As an Administrator
  I should see only public emails in a contact activity list
  ...
  Scenario: Should see public email in contact activity list
  ...
  Scenario: When an email become private email it should be removed from contact activity list
  ...
  Scenario: When an email become public email it should be added in contact activity list
    Given I go to System/User Management/Users
    And click Edit admin in grid
    When fill form with:
