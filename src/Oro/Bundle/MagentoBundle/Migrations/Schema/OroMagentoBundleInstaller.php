...
namespace Oro\Bundle\MagentoBundle\Migrations\Schema;
    ...
    NoteExtensionAwareInterface
{
    ...
    /**
     * Create oro_magento_region table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Create oro_magento_cart_address table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Create oro_magento_order table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Create oro_magento_order_emails table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Create oro_magento_customer_group table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Create oro_magento_customer table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Create oro_magento_cart_item table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Create oro_magento_customer_addr table
     *
     * @param Schema $schema
     */
    protected function createOrocrmMagentoCustomerAddrTable(Schema $schema)
    {
        $table = $schema->createTable('oro_magento_customer_addr');
        $table->addColumn('id', 'integer', ['precision' => 0, 'autoincrement' => true]);
        $table->addColumn('owner_id', 'integer', ['notnull' => false]);
    ...
    /**
     * Create oro_magento_cust_addr_type table
     *
     * @param Schema $schema
     */
    protected function createOrocrmMagentoCustAddrTypeTable(Schema $schema)
    {
        $table = $schema->createTable('oro_magento_cust_addr_type');
    ...
    /**
     * Create oro_magento_order_address table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Create oro_magento_order_addr_type table
     *
     * @param Schema $schema
     */
    ...
    {
        $table = $schema->createTable('oro_magento_prod_to_website');
    ...
    /**
     * Create oro_magento_cart_emails table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Create oro_magento_cart_status table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Create oro_magento_order_items table
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_cart_address foreign keys.
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_order foreign keys.
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_order_emails foreign keys.
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_customer_group foreign keys.
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_customer foreign keys.
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_cart_item foreign keys.
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_customer_addr foreign keys.
     *
     * @param Schema $schema
     */
    protected function addOrocrmMagentoCustomerAddrForeignKeys(Schema $schema)
    {
        ...
        $table->addForeignKeyConstraint(
            $schema->getTable('oro_contact_phone'),
    ...
    /**
     * Add oro_magento_cust_addr_type foreign keys.
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_order_address foreign keys.
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_order_addr_type foreign keys.
     *
     * @param Schema $schema
     */
    ...
    {
        $table = $schema->getTable('oro_magento_prod_to_website');
        $table->addForeignKeyConstraint(
    ...
    /**
     * Add oro_magento_cart foreign keys.
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_cart_emails foreign keys.
     *
     * @param Schema $schema
     */
    ...
    /**
     * Add oro_magento_order_items foreign keys.
     *
     * @param Schema $schema
     */
    ...
    {
        $this->activityExtension->addActivityAssociation($schema, 'oro_email', 'oro_magento_customer');
        $this->activityExtension->addActivityAssociation($schema, 'oro_calendar_event', 'oro_magento_customer');
    ...
    {
        $this->identifierEventExtension->addIdentifierAssociation($schema, 'oro_magento_customer');
        $this->visitExtension->addVisitEventAssociation($schema, 'oro_magento_cart');
        $this->visitExtension->addVisitEventAssociation($schema, 'oro_magento_customer');
        $this->visitExtension->addVisitEventAssociation($schema, 'oro_magento_order');
        $this->visitExtension->addVisitEventAssociation($schema, 'oro_magento_product');
    }
}
