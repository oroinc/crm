...
namespace OroCRM\Bundle\MagentoBundle\Migrations\DataFixtures\Demo\ORM;
...
class LoadDemoMagentoData extends AbstractFixture implements DependentFixtureInterface
{
    ...
    {
        return ['OroCRM\Bundle\DemoDataBundle\Migrations\DataFixtures\Demo\ORM\LoadContactData'];
    }
