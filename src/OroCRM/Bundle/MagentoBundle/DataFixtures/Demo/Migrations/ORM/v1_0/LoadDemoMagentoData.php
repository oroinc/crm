...
namespace OroCRM\Bundle\MagentoBundle\DataFixtures\Demo\Migrations\ORM\v1_0;
...
class LoadDemoMagentoData extends AbstractFixture implements DependentFixtureInterface
{
    ...
    {
        return ['OroCRM\Bundle\DemoDataBundle\DataFixtures\Demo\Migrations\ORM\v1_0\LoadContactData'];
    }
    ...
    private function loadDictionary($name)
    {
        ...
        if (!isset($dictionaries[$name])) {
            ...
            $fileName   = __DIR__
                . DIRECTORY_SEPARATOR
                . '../../../../../../DemoDataBundle/DataFixtures/Demo/Migrations/ORM/v1_0/dictionaries' .
