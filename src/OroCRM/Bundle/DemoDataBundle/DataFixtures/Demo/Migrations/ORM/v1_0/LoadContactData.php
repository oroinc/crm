...
class LoadContactData extends AbstractFixture implements ContainerAwareInterface, DependentFixtureInterface
{
    ...
    {
        return [
            'OroCRM\Bundle\DemoDataBundle\DataFixtures\Demo\Migrations\ORM\v1_0\LoadGroupData',
            'OroCRM\Bundle\DemoDataBundle\DataFixtures\Demo\Migrations\ORM\v1_0\LoadContactGroupData',
