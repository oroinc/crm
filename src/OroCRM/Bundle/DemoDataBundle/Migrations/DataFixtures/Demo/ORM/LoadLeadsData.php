...
class LoadLeadsData extends AbstractFixture implements ContainerAwareInterface, DependentFixtureInterface
{
    ...
    {
        return [
            'OroCRM\Bundle\DemoDataBundle\Migrations\DataFixtures\Demo\ORM\LoadUsersData',
            'OroCRM\Bundle\DemoDataBundle\Migrations\DataFixtures\Demo\ORM\LoadAccountData',
            'OroCRM\Bundle\DemoDataBundle\Migrations\DataFixtures\Demo\ORM\LoadAclData',
            'OroCRM\Bundle\DemoDataBundle\Migrations\DataFixtures\Demo\ORM\LoadLeadSourceData'
        ];
    }
