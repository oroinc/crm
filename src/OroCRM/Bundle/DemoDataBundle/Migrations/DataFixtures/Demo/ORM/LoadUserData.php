...
class LoadUserData extends AbstractFixture implements ContainerAwareInterface, DependentFixtureInterface
{
    ...
    {
        return [
            'OroCRM\Bundle\DemoDataBundle\Migrations\DataFixtures\Demo\ORM\LoadGroupData',
            'OroCRM\Bundle\DemoDataBundle\Migrations\DataFixtures\Demo\ORM\LoadBusinessUnitData'
        ];
    }
