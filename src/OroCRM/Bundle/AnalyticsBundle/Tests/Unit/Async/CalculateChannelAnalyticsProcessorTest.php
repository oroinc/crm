...
use OroCRM\Bundle\AnalyticsBundle\Tests\Unit\Model\Stub\CustomerAwareStub;
...
class CalculateChannelAnalyticsProcessorTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testShouldRunCalculateAnalyticsAsUniqueJob()
    {
        ...
        self::assertEquals('orocrm_analytics:calculate_channel_analytics:theChannelId', $uniqueJobs[0]['jobName']);
