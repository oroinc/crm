...
namespace OroCRM\Bundle\ContactUsBundle\Migrations\Schemas\v1_0;
...
class OroCRMContactUsBundle implements Migration
{
    ...
    public function up(Schema $schema)
    {
        ...
        $table->addForeignKeyConstraint($schema->getTable('orocrm_contactus_contact_reason'), ['contact_reason_id'], ['id'], ['onDelete' => null, 'onUpdate' => null]);
        ...
        $table = $schema->getTable('orocrm_contactus_request_emails');
        $table->addForeignKeyConstraint($schema->getTable('oro_email'), ['email_id'], ['id'], ['onDelete' => 'CASCADE', 'onUpdate' => null]);
        $table->addForeignKeyConstraint($schema->getTable('orocrm_contactus_request'), ['request_id'], ['id'], ['onDelete' => 'CASCADE', 'onUpdate' => null]);
        /** End of generate foreign keys for table orocrm_contactus_request_emails **/
